      ...
      {value ? (
        ...
        >
          {selectedProject?.isGit ? (
            ...
            <FolderLineIcon size={14} className="text-[var(--color-text-secondary)]" />
          )}
          ...
          {mode === 'recent' ? (
            <>
                    ...
                    return (
                      ...
                      >
                        {project.isGit ? (
                          ...
                          <FolderLineIcon size={20} className="flex-shrink-0 text-[var(--color-text-secondary)]" />
                        )}
              ...
              <div className="border-t border-[var(--color-border)]">
                ...
                >
                  <FolderLineIcon size={20} className="text-[var(--color-text-tertiary)]" />
                  ...
                  <>
                    ...
                    {browseEntries.length === 0 ? (
                      ...
                      >
                        ...
                        >
                          <FolderLineIcon size={16} className="shrink-0 text-[var(--color-text-tertiary)]" />
                          <span className="truncate text-xs text-[var(--color-text-primary)]">{entry.name}</span>
                        </button>
                        <button type="button" onClick={() => handleSelect(entry.path)} className="px-2 py-0.5 text-[10px] font-semibold text-[var(--color-brand)] hover:bg-[var(--color-primary-fixed)] rounded transition-colors">
                          {t('common.select')}
                        </button>
                      </div>
                    ))}
