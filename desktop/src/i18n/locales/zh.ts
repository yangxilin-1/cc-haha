...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.general.storagePortableDirPlaceholder': '选择一个用于保存 Ycode 数据的文件夹',
  ...
  'settings.general.notificationsTestTitle': 'Ycode 通知已启用',
  ...
  'empty.heroQuestion': '要在 {project} 中构建什么？',
  'empty.codeSubtitle': '围绕当前项目目录提问、修改代码并直接发起本地任务。',
  'empty.placeholder': '问 Ycode 任何事，输入 @ 提及文件',
