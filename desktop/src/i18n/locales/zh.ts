...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.providers.localName': '本地模型',
  'settings.providers.localDesc': '连接本机 llama.cpp OpenAI 兼容服务',
  'settings.providers.localConfig': 'http://127.0.0.1:8012 · gemma-4-26B-A4B-it-UD-IQ3_S',
  'settings.providers.localHint': '按 LLAMA_CPP_AUTO_START=true 配置，后端启动时会尝试拉起 llama.cpp；这里会切换到本地服务。',
  'settings.providers.connectLocal': '连接本地服务',
  'settings.providers.localConnected': '已连接本地服务',
  ...
  'settings.providers.presetDesc.openai': 'OpenAI API 默认接入，适合 OpenAI API Key。',
  'settings.providers.presetDesc.local-llama': '连接本机 llama.cpp 服务。',
  'settings.providers.presetDesc.deepseek': 'DeepSeek Anthropic 兼容接口，适合国内网络环境。',
  'settings.providers.presetDesc.zhipuglm': '智谱 GLM Anthropic 兼容接口。',
  'settings.providers.presetDesc.kimi': 'Moonshot Kimi Anthropic 兼容接口。',
  'settings.providers.presetDesc.minimax': 'MiniMax Anthropic 兼容接口。',
  'settings.providers.presetDesc.custom': '手动填写接口地址、协议格式和模型 ID。',
  ...
  'settings.providers.openApiKeyPage': '获取 Key',
  'settings.providers.advancedSettings': '自定义配置',
  'settings.providers.advancedSettingsDesc': '接口地址、协议格式、备注和 JSON。',
  'settings.providers.modelMapping': '模型配置',
  'settings.providers.modelConfigHint': '可直接填写任意模型 ID；留空的槽位保存时会沿用默认模型。',
  'settings.providers.modelIdPlaceholder': '例如 gpt-5、deepseek-chat、kimi-k2.5',
  'settings.providers.copyMainModel': '全部使用默认模型',
  'settings.providers.mainModel': '默认模型',
  'settings.providers.haikuModel': '快速模型',
  'settings.providers.sonnetModel': '标准模型',
  'settings.providers.opusModel': '强力模型',
  'settings.providers.sameAsMain': '留空则使用默认模型',
  'settings.providers.testConnection': '测试连接',
  'settings.providers.settingsJson': '设置 JSON',
  'settings.providers.settingsJsonDesc': 'Ycode settings.json — 直接编辑，保存时写入。',
  ...
  'settings.permissions.default': '默认权限',
  'settings.permissions.defaultDesc': '非文件操作默认允许；写入、修改或删除文件前询问',
  'settings.permissions.acceptEdits': '自动接受编辑',
  'settings.permissions.acceptEditsDesc': '文件编辑也自动允许',
  'settings.permissions.plan': '计划模式',
  'settings.permissions.planDesc': '仅思考和规划，不执行操作',
  'settings.permissions.bypass': '完全访问权限',
  'settings.permissions.bypassDesc': 'Shell 和文件系统完整工具访问',

  // Settings > Adapters
  'settings.tab.adapters': 'IM 接入',
  'settings.adapters.description': '配置即时通讯适配器，通过 Telegram 或飞书与 Ycode 桌面会话对话。',
  ...
  'settings.adapters.appIdPlaceholder': '如 app_xxx',
  ...
  'settings.agents.source.flagSettings': 'Runtime 参数',
  'settings.agents.source.built-in': '内置',

  // Settings > Skills
  'settings.skills.title': '已安装技能',
  'settings.skills.description': '技能扩展 Ycode 的能力。在 Ycode 桌面技能目录中管理技能。',
  ...
  'settings.skills.emptyHint': '在 Ycode 桌面技能目录中添加技能即可开始',
  ...
  'settings.computerUse.description': '允许 Ycode 截屏、观察界面、点击、打字并操作本机应用。开启整台电脑授权后，Computer Use 不再为每个软件单独弹窗。',
  ...
  'settings.computerUse.environmentTitle': '运行环境',
  'settings.computerUse.environmentDescription': '首次使用需要准备 Python 运行时和桌面自动化依赖。',
  'settings.computerUse.readyBadge': '已就绪',
  ...
  'settings.computerUse.appsTitle': '应用与工具',
  'settings.computerUse.appsDescription': '展示真实可打开的应用、Python 工具、Windows 工具和其它软件；已过滤卸载器、安装器和后台组件。',
  'settings.computerUse.appsLoading': '加载已安装的 App...',
  'settings.computerUse.appsEmpty': '未找到已安装的 App，请先安装环境。',
  'settings.computerUse.appsNoResults': '没有匹配的 App。',
  'settings.computerUse.appsNoCommon': '没有可展示的应用；可用搜索框查找需要授权的软件。',
  'settings.computerUse.appsSearch': '搜索 App...',
  'settings.computerUse.appsSaving': '保存中...',
  'settings.computerUse.appsSaved': '已保存',
  'settings.computerUse.appsSaveFailed': '保存失败',
  'settings.computerUse.appsSaveVerifyFailed': '配置没有真正写回，请重启桌面服务后再试。',
  'settings.computerUse.authorizedCount': '已授权 {count}',
  'settings.computerUse.computerWideTitle': '授权整台电脑',
  'settings.computerUse.computerWideDescriptionOn': '已允许 Computer Use 操作所有软件，执行任务时不会再弹出单个 App 授权确认。',
  'settings.computerUse.computerWideDescriptionOff': '关闭后恢复按 App 授权：列表中未授权的软件会在实际操作前弹窗确认。',
  'settings.computerUse.computerWideEnabled': '整机授权已开启',
  'settings.computerUse.computerWideAllowed': '整机允许',
  'settings.computerUse.appAuthorized': '已授权',
  'settings.computerUse.appNeedsPrompt': '需要弹窗',
  'settings.computerUse.appCategoryFallback': '应用',
  'settings.computerUse.categoryDevelopment': '开发工具',
  'settings.computerUse.categoryPython': 'Python 工具',
  'settings.computerUse.categoryWindows': 'Windows / Power 工具',
  'settings.computerUse.categoryBrowser': '浏览器',
  'settings.computerUse.categoryOffice': '办公',
  'settings.computerUse.categoryCommunication': '沟通',
  'settings.computerUse.categoryMusic': '音乐',
  'settings.computerUse.categoryNotes': '笔记',
  'settings.computerUse.categoryDesign': '设计',
  'settings.computerUse.categoryTools': '工具',
  'settings.computerUse.categorySystem': '系统',
  'settings.computerUse.categoryOther': '其他应用',
  ...
  'toolGroup.readSkill': '读取了 {skill} 技能',
  'toolGroup.readSkillGeneric': '读取了技能',
  ...
  'agentStatus.writing': '正在回复',
  'agentStatus.callingTool': '正在调用 {toolName}',
  'agentStatus.waitingApproval': '等待授权',
  'toolGroup.searchedWeb': '搜索了网页',
  'toolGroup.fetchedOne': '获取了一个页面',
  'toolGroup.fetchedMany': '获取了 {count} 个页面',
  'toolGroup.checkedWeather': '查询了天气',
  'toolGroup.calculated': '完成了计算',
  'toolGroup.checkedTime': '查看了时间',
  'toolName.time': '时间',
  'toolName.calculator': '计算器',
  'toolName.weather': '天气',
  'toolName.webSearch': '网页搜索',
  'toolName.webFetch': '网页读取',
  'toolName.readFile': '读取文件',
  'toolName.listFiles': '文件列表',
  'toolName.search': '搜索',
  'toolName.writeFile': '写入文件',
  'toolName.editFile': '编辑文件',
  'toolName.patch': '补丁',
  'toolName.shell': '终端',
  ...
  'permMode.askPermissions': '默认权限',
  'permMode.askPermDesc': '非文件操作默认允许；只在操作文件前询问',
  ...
  'permMode.label.default': '默认权限',
  'permMode.label.acceptEdits': '自动编辑',
  ...
  'fileSearch.noDirectory': '先选择项目目录才能引用文件',
  ...
  // ─── Error Codes ──────────────────────────────────────
  'error.CLI_NOT_RUNNING': '桌面 runtime 未运行。会话可能已结束或进程已崩溃。',
  'error.CLI_START_FAILED': '桌面 runtime 启动失败。',
  'error.CLI_AUTH_REQUIRED': '需要认证。请先登录。',
  'error.CLI_SESSION_CONFLICT': '会话已被其他进程占用。',
  'error.CLI_SPAWN_FAILED': '桌面 runtime 进程启动失败。',
  ...
  'error.PROVIDER_NOT_CONFIGURED': '还没有可用的模型服务商。请在设置里添加或启用一个服务商。',
  'error.PROVIDER_REQUEST_FAILED': '模型服务商请求失败。请检查当前模型、接口地址和 API 密钥后重试。',
  'error.INVALID_MODEL_ID': '当前模型不可用。请在设置里选择该服务商支持的模型后重试。',
  'error.PROVIDER_AUTH_FAILED': '模型服务商认证失败。请检查 API 密钥，或重新登录。',
  'error.DESKTOP_RUNTIME_ERROR': '桌面运行时处理这次请求失败。',
