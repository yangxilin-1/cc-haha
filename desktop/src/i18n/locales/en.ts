export const en = {
  ...
  'settings.activity.defaultHandle': 'Ycode',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for Ycode data',
  ...
  'settings.general.notificationsTestTitle': 'Ycode notifications are enabled',
  ...
  'empty.heroQuestion': 'What do you want to build in {project}?',
  'empty.codeSubtitle': 'Ask in the current project, edit code, and start local tasks directly.',
  'empty.placeholder': 'Ask Ycode anything, type @ to mention files',
